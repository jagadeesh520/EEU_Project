import React from 'react'
 ...
 export const constant = {
    ...
    KEBELE: '/kebeleProd',
    CSC: '/cscProd',
    SERVICE_SHIFTING: '/serviceShiftingProd',
    MOVE_OUT: '/MoveOutProd',
    DISCONNECT_RE_CONNECT: '/DisconnectionProd',
    LOAD_CHANGE: '/LoadChangeProd',
    MISCELLANEOUS: '/MiscellaneousProd',
